...
- [Phase 8 AI Product Optimization](phase8-ai-optimization.md) — Groq structured JSON (response_format json_object), fire-and-forget in sync, aiOptimization JSONB + aiOptimizationStatus columns, /dashboard/products frontend.
